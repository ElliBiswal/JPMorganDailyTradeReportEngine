...
public class InstructionDetails {
    ...
    private static BigDecimal calculateAmount(InstructionDetails id) {
        return id.getPricePerUnit()
                .multiply(BigDecimal.valueOf(id.getUnits()))
                .multiply(id.getAgreedFx());
    }
